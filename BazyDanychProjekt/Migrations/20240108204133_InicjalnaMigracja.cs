...
{
    /// <inheritdoc />
    public partial class InicjalnaMigracja : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Haslo = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    ...
                    Rola = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Kraj = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    Miasto = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    Gwiazdki = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumerPokoju = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    TypPokoju = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Zdjecia_Hotele_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Hotele",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataPoczatek = table.Column<DateTime>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rezerwacja_Pokoj_PokojId",
                        column: x => x.PokojId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pokoj_HotelId",
                table: "Pokoj",
                column: "HotelId");

            migrationBuilder.CreateIndex(
                name: "IX_Rezerwacja_PokojId",
                table: "Rezerwacja",
                column: "PokojId");
